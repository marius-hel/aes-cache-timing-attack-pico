...
def main(arg):
    ...
    print(f"{known_count} bits are supposed known with a probability >= {min_prob}")
    print("From left to right: k[0] ... k[15] ")
    print(key_bits_str)
    exit(0)

if __name__ == "__main__":
    parser = argparse.ArgumentParser(description='Analyze known bits in <file> after correlation, <prob> is the minimum probability for a bit to be qualified as known')
